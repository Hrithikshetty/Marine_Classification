  ...
  const handleSubmit = async () => {
    ...
    try {
        const response = await fetch("http://localhost:50603/predict", {
            ...
            body: formData,
            headers: {
                // "Content-Type": "multipart/form-data"  // This header is not needed when using FormData
            }
        });
  ...
  return (
    <>
      <div className="h-full bg-black">
        <header className="py-10.5 lg:py-14.5 py-4 bg-black">
          <div className="container grid items-center gap-8 px-6 lg:px-8 xl:px-8">
            <Link href="#">
              <div className="text-white flex items-center space-x-2 cursor-pointer">
                <MountainIcon className="w-8 h-8" />
                <span className="text-2xl font-bold">Auto-Fis</span>
              </div>
            </Link>
          </div>
        </header>
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                ...
                <div className="flex items-center gap-4 text-white">
                  ...
                  <Button type="submit" className="flex items-center text-white w-32" variant="outline">
                    Submit
                  </Button>
                </div>
              </form>
