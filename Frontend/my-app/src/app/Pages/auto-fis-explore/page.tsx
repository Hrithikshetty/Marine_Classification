  ...
  return (
    <>
      <div className="h-full bg-black">
        <header className=" py-10.5 h-5 lg:py-14.5 py-4 bg-black">
                ...
                <div className="bg-black border border-dashed rounded-lg w-full p-6 flex flex-col items-center gap-2 border-gray-200 shadow-sm transition-colors hover:border-gray-300 focus-within:outline-none focus-within:border-gray-300 dark:border-gray-800 dark:border-gray-800">
                  {image ? (
                    ...
                    <>
                      ...
                      <label
                        className="inline-flex h-8 items-center rounded-md border-10 border-dashed bg-gray-50 px-4 text-sm font-medium shadow-sm cursor-pointer transition-colors hover:bg-gray-100 hover:text-gray-900"
                        htmlFor="file-upload"
                      >
                        <input
                          className="sr-only "
